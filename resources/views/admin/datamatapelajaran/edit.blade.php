...
@section('content')
    <div class="edit-mapel-container py-5">
        <div class="container">
                    ...
                    <div class="card border-0 shadow-lg rounded-lg">
                        <div class="card-header bg-gradient-primary p-4 border-0">
                            <div class="d-flex justify-content-between align-items-center">
                                <h3 class="text-black mb-0 font-weight-bold">Edit Mata Pelajaran</h3>
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('datamatapelajaran.update', $mapel->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="kode" id="kode"
                                            ...
                                            value="{{ old('kode', $mapel->kode) }}" maxlength="10" required>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="mata_pelajaran" id="mata_pelajaran"
                                            class="form-control border-0 bg-light py-2"
                                            value="{{ old('mata_pelajaran', $mapel->mata_pelajaran) }}" required>
                                    </div>
                                </div>
