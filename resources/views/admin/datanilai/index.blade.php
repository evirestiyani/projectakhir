...
@section('content')
                    ...
                    <div class="card-body p-4">
                        <div class="d-sm-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h2 class="fw-bold text-white mb-0">Manajemen Data Nilai</h2>
                                <p class="text-white-50 mt-2 mb-0">Kelola dan lihat semua data nilai murid di satu tempat</p>
                            </div>
                            <div class="mt-3 mt-sm-0">
                                <a href="{{ route('admin.datanilai.create') }}" class="btn btn-light text-dark">
                ...
                <div class="card card-stats border-0 shadow-sm h-100">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold text-muted">Totall Nilai</p>
                                    <h3 class="font-weight-bold mb-0">{{ $nilai->count() }}</h3>
                                </div>
                            </div>
                ...
                <div class="card card-stats border-0 shadow-sm h-100">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold text-muted">Total Mata Pelajaran
                                    </p>
                        ...
                        <div class="row align-items-center">
                                ...
                                <form method="GET" action="{{ route('admin.datanilai.index') }}" class="d-flex">
                                    <div class="input-group w-100">
                                        ...
                                        <input type="text" class="form-control ps-0 border-start-0" name="search"
                                            ...
                                            placeholder="Cari nilai berdasarkan nama siswa..." style="width: 70%;">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex justify-content-md-end">
                                    ...
                                    <a href="{{ route('admin.datanilai.exportTxt', request()->query()) }}"
                                        class="btn btn-info">
                                        <i class="fas fa-file-alt"></i> Export ke TXT
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <form method="GET" action="{{ route('admin.datanilai.index') }}" class="row g-3">
                        <div class="col-md-3">
                            ...
                            <select name="mapel" class="form-select form-select-sm">
                                ...
                                @foreach ($mapel as $m)
                                    <option value="{{ $m->id }}"
                                        {{ request('mapel') == $m->id ? 'selected' : '' }}>{{ $m->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="predikat" class="form-select form-select-sm">
                                ...
                                @foreach (['A', 'B', 'C', 'D', 'E'] as $p)
                                    <option value="{{ $p }}"
                                        {{ request('predikat') == $p ? 'selected' : '' }}>{{ $p }}</option>
                                @endforeach
                            </select>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="avatar-sm rounded-circle bg-soft-primary text-primary me-3 d-flex align-items-center justify-content-center">
                                    ...
                                    <td>
                                        <span class="badge bg-soft-info text-info rounded-pill px-3 py-2">
                                            {{ $n->mataPelajaran->mata_pelajaran ?? 'Tidak Ditemukan' }}
                                        </span>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="progress flex-grow-1 me-2" style="height: 6px;">
                                                <div class="progress-bar bg-success" role="progressbar"
                                                    ...
                                                    aria-valuenow="{{ $n->nilai }}" aria-valuemin="0"
                                                    aria-valuemax="100">
                                                </div>
                                            </div>
                                    ...
                                    <td>
                                        <span
                                           ...
                                           @elseif($n->predikat == 'E') bg-soft-secondary text-danger
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    <div class="modal-body p-4 text-center">
                        <div class="rounded-circle bg-success d-inline-flex align-items-center justify-content-center p-3 mb-4"
                            style="width: 50px; height: 50px;">
                            <i class="fas fa-check text-white fa-2x"></i>
                        </div>
                        <h4 class="modal-title fw-bold mb-3" id="successModalLabel">Berhasil!</h4>
                        <p class="mb-4">{{ session('success') }}</p>
                        <div class="progress mb-3" style="height: 5px;">
                            <div class="progress-bar bg-success" role="progressbar" style="width: 0%;"
                                id="successProgressBar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <button type="button" class="btn btn-success px-4 py-2" data-bs-dismiss="modal">
                            <i class="fas fa-check-circle me-2"></i> Oke
                        </button>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const filterButton = document.querySelector('[data-bs-target="#advancedFilter"]');
            if (filterButton) {
